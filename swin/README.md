...
To train Swin model using multiple GPUs in hybrid parallel fashion, run the following scripts:
``` shell
...
A sample layerwise hybrid parallel strategy for Swin-Huge-32 is given in the code: 

For layer 0-1, apply strategy 1-way PP, 1-way TP, 8-way SDP;
for layer 2-3, apply strategy 1-way PP, 1-way TP, 8-way DP;
for layer 4-29, apply strategy 1-way PP, 1-way TP, 8-way SDP.
for layer 30-31, apply strategy 1-way PP, 2-way TP, 4-way SDP.
